...
function Cart() {
    ...
    return (
        <>
            <div>
                <div className="flex items-center justify-center py-8 mb-20">
                    <button onClick={() => setShow(!show)} className="py-2 px-10 rounded bg-gray-800 hover:bg-gray-800 text-white">
                        Open Cart
                    </button>
                </div>
                {show && (
